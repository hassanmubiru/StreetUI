...
hoistedDependencies:
  ...
  '@eslint-community/eslint-utils@4.10.1(eslint@9.13.0)':
  ...
  '@vitest/mocker@2.1.4(vite@5.4.21(@types/node@26.6.2))':
  ...
  any-promise@1.3.0:
    any-promise: private
  apps/docs:
    '@streetui/docs': private
  apps/playground:
    '@streetui/playground': private
  argparse@2.0.1:
    argparse: private
  ...
  esutils@2.0.3:
    esutils: private
  examples/basic-app:
    '@streetui/example-basic-app': private
  examples/streetui-account:
    '@streetui/example-account': private
  examples/streetui-data:
    '@streetui/example-data': private
  examples/streetui-docs:
    '@streetui/example-docs': private
  examples/streetui-full-app:
    '@streetui/example-full-app': private
  examples/streetui-performance-app:
    '@streetui/example-performance-app': private
  examples/streetui-showcase:
    '@streetui/example-showcase': private
  examples/streetui-ssr:
    '@streetui/example-ssr': private
  expect-type@1.4.0:
    expect-type: private
  ...
  packages/benchmarks:
    '@streetui/benchmarks': private
  packages/cli:
    '@streetui/cli': private
  packages/compiler:
    '@streetui/compiler': private
  packages/context:
    '@streetui/context': private
  packages/core:
    '@streetui/core': private
  packages/devtools:
    '@streetui/devtools': private
  packages/dom:
    '@streetui/dom': private
  packages/dsl:
    '@streetui/dsl': private
  packages/events:
    '@streetui/events': private
  packages/forms:
    '@streetui/forms': private
  packages/graph:
    '@streetui/graph': private
  packages/i18n:
    '@streetui/i18n': private
  packages/renderer:
    '@streetui/renderer': private
  packages/router:
    '@streetui/router': private
  packages/runtime:
    '@streetui/runtime': private
  packages/scheduler:
    '@streetui/scheduler': private
  packages/state:
    '@streetui/state': private
  packages/streetui:
    streetui: private
  packages/testing:
    '@streetui/testing': private
  parent-module@1.0.1:
  ...
  uri-js@4.4.1:
    uri-js: private
  vite-node@2.1.4(@types/node@26.6.2):
    vite-node: private
  vite@5.4.21(@types/node@26.6.2):
    vite: private
...
pendingBuilds: []
prunedAt: Wed, 23 Sep 2026 03:34:33 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - turbo-windows-64@2.3.3
  - turbo-windows-arm64@2.3.3
storeDir: /home/error51/.local/share/pnpm/store/v3
